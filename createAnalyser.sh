...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/work/s/ssuurper/ttbar_studies_workdir/myworkdir/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/work/s/ssuurper/ttbar_studies_workdir/myworkdir/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/work/s/ssuurper/ttbar_studies_workdir/myworkdir/bin/${ananame}.cpp
